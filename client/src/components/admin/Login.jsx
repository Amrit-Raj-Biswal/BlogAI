      ...
      <div className='w-full max-w-sm p-6 max-md:m-6 border border-blue-600/30 shadow-xl shadow-blue-600/15 rounded-lg'>
        <div className='flex flex-col items-center justify-center'>
            <div className='w-full py-6 text-center'>
                <h1 className='text-3xl font-bold'><span className='text-blue-600'>Admin</span> Login</h1>
            ...
            <button type='submit' className='w-full  text-white bg-blue-600/70 py-3 font-medium rounded cursor-pointer hover:bg-blue-600'>Login</button>
            </form>
